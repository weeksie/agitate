defmodule Agitate.Web.District do
  ...
  schema "districts" do
    ...
    many_to_many :zip_codes, Agitate.Web.ZipCode, join_through: "district_zip_codes"
    belongs_to :state, Agitate.Web.State
    belongs_to :representative, Agitate.Web.Representative
