defmodule Agitate.Web.Schema.Types do
  ...
  object :district do
    ...
    #     batch({Agitate.Web.Schema.Helpers, :by_id, Agitate.Representative}, rep_id, fn batch_results ->
  ...
  object :zip_code do
    ...
    field :lat, :float
    field :lon, :float
    field :districts, list_of(:district)# , resolve: &Agitate.Web.DistrictResolver.by_zip/2
  end
end
